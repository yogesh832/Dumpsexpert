...
import { FaCheckCircle, FaArrowUp, FaMoneyBill } from "react-icons/fa";
import banner from "../../assets/landingassets/banner.webp";
const HeroSection = () => {
  return (
    <div className="w-full bg-white py-12 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between">
      {/* Left Content */}
